	...
	<table class="edit-table">
		@foreach($volunteers as $volunteer)
			<tr>
				...
				<td>
					<a href="benevole/{{ $volunteer->id }}"><h3>{{ $volunteer->name }} <img src="/img/flags/{{ $volunteer->nationality }}.png" height="20px"></h3>(#{{ $volunteer->id }}) {{ $volunteer->get_date_string('start') }} - {{ $volunteer->get_date_string('leave') }}</a><br>
